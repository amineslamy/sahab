        ...
        t.div(
            ...
            t.div(
                ...
                app.components.codeEditor({
                    ...
                    required: true,
                    name: "query",
                    placeholder: "مثال: توضیح طرح پرس و جو SELECT * from users WHERE verified=true",
            ...
            t.div(
                ...
                t.div(
                    ...
                    t.ul(
                        null,
                        t.li(null, "ردیف‌های برگشتی تا سقف ۱۰۰۰ محدود شده‌اند."),
                        t.li(null, "کوئری‌های اجرا شده حداکثر ۳ دقیقه مهلت دارند."),
                        t.li(null, "داده‌ها به صورت رشته‌های بایتی و بدون هیچ قالب‌بندی اضافی بازگردانده می‌شوند."),
                        t.li(null, "چندین پرس‌وجو پشتیبانی می‌شوند، اما فقط نتیجه آخرین پرس‌وجو برگردانده می‌شود."),
                    ),
                ),
            ),
            // error alert
